...
function warmup_instructions_html(condition) {
    return `
            <p id="instruct-text" class="left">Now that you've seen some example scenarios, we'll begin with the <strong>warm‑up scenarios</strong>.</p>
