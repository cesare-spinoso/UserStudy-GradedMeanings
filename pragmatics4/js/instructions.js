...
function warmup_instructions_html(condition) {
    return `
            ...
            <p>For each warm‑up, use the slider to indicate how likely you believe the interpretations/consequences provided are. No rationales are needed for warm‑ups.</p>
        `;
}