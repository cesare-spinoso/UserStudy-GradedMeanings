...
function alternative_utterance_html(speaker_name, alternative_utterance) {
    return `In addition, assume that ${speaker_name} <em>could have said</em> \"<span style="color: #318500;">${alternative_utterance}</span>\" but that they <em>intentionally chose not to</em>.`;
}